...
use Spatie\Multitenancy\TenantFinder\CurrentUserTenantFinder;
...
return [
     ...
     *
     */
    'tenant_finder' => \App\TenantFinder\CurrentUserTenantFinder::class,
    ...
    'user_tenant_finder_field' => 'company_id',

    'landlord_models' => [
        // Contoh: Model Role adalah data global, bukan milik satu perusahaan
