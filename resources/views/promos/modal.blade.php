<div id="promoModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 hidden flex items-center justify-center z-50">
    <div class="bg-white rounded-lg shadow-xl p-6 w-full max-w-2xl">
        <div class="flex justify-between items-center border-b pb-3 mb-4">
            <h3 id="modal_title" class="text-xl font-semibold">Tambah Promo</h3>
        ...
        <form id="promoForm">
            ...
            <div class="space-y-4">
                ...
                <div>
                    <label for="name" class="block text-sm font-medium text-gray-700">Nama Promo</label>
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="number" name="value" id="value" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                        <span id="value_error" class="text-red-500 text-xs error-message"></span>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <span id="start_date_error" class="text-red-500 text-xs error-message"></span>
                    </div>
                    <div>
                        ...
                        <span id="end_date_error" class="text-red-500 text-xs error-message"></span>
                    </div>
                </div>

                <div>
                    <label class="block text-sm font-medium text-gray-700">Pilih Produk</label>
                    <select name="products[]" id="products" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" multiple>
                        @if($products->count() > 0)
                    ...
                    <span id="products_error" class="text-red-500 text-xs error-message"></span>
                </div>
            </div>
